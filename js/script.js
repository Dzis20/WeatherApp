$(function(){
  ...
  $('#btn').on('click', function(){
    ...
    //Здесь вам нужно вставить свой бесплатный ключ
      var apiURI2 = `https://api.openweathermap.org/data/2.5/forecast?q=${city}&appid=ae136fb25171bb1c503cd41aa85e705e`;
          ...
          $.ajax({
            ...
            timeout : 500,
                      ...
                      error : function(e) {
                          console.log("Error");
                          $('#message').html('<p style="color:red";>ERROR</p><p style="color:#bef7f1";>Проверьте корректность названия</p>');
